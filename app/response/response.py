...
class JSONResponse:
    ...
    API_1020_UserNotFoundInDatabase = {'status': 'ok','code': 1020,'message': 'UserNotFoundInDatabase','data': None}
    API_1021_ClanNotFoundInDatabase = {'status': 'ok','code': 1021,'message': 'ClanNotFoundInDatabase','data': None}
