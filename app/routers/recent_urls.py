...
@router.get("/features/user/{region}/{account_id}/overview/", description="获取用户Recent功能是否启用")
...
@router.get("/features/users/{region}/", description="获取服务器下所有启用用户的id")
...
@router.post("/features/user/", description="启用用户Recent功能")
...
@router.put("/features/user/", description="更新用户Recent功能的数据")
...
@router.delete("/features/user/{region}/{account_id}/", description="删除用户Recent功能")
